...
Route::group(["prefix" => "v0.0.1"], function(){
    ...
    Route::group(['middleware' => 'auth:api'], function(){
        ...
        Route::get('/add_favorite/{user_id}', [AuthController::class, "addFavorite"]);
        Route::get('/remove_favorite_Or_Block/{user_id}', [AuthController::class, "removeFavoriteOrBlock"]);
        Route::get('/add_block/{user_id}', [AuthController::class, "addBlock"]);
